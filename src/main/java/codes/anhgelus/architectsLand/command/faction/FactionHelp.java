...
public class FactionHelp {
    ...
    public boolean command() {
        commandSender.sendMessage(Static.SUCCESS + "Help faction command:\n\n" +
                ...
                Static.SUCCESS + "/f modify <faction> <prefix | name> <modification> - Modify a faction " + Static.EXAMPLE + "(you need" + FactionModify.PERMISSION + "permission to delete it)" + Static.EOL +
                Static.SEPARATOR + Static.EOL);
        return true;
    }
}
